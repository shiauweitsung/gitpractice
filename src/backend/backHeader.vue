          ...
          <ul class="navbar-nav mr-auto">
            <li class="nav-item active">
              <router-link class="nav-link" to="/admin"
                >動物資訊
                <span
                  ><img src="~@/assets/images/backend/pets.png" alt="" /></span
                ><span class="sr-only">(current)</span></router-link
              >
            </li>
            <li class="nav-item">
              <router-link class="nav-link" to="/admin/reserve"
                >已預約領養紀錄
                <span
                  ><img
                    src="~@/assets/images/backend/veterinary.png"
                    alt="" /></span
                ><span class="sr-only">(current)</span></router-link
              >
            </li>
